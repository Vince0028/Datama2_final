...
export const getRoomWithType = (room) => {
    const roomType = roomTypes.find(rt => rt.RoomType_ID === room.RoomType_ID);
    return { ...room, roomType };
};
export const getReservationWithDetails = (reservation) => {
...
export const calculateDashboardMetrics = () => {
    ...
    const activeReservations = reservations.filter(r => r.Status === 'Booked' || r.Status === 'CheckedIn').length;
