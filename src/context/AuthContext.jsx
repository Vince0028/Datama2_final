...
export function AuthProvider({ children }) {
    ...
    const signup = async (email, password, guestData) => {
        setIsLoading(true);
        ...
        if (newGuest) {
            ...
            if (accError)
                console.error("Error linking UserAccount:", accError);
        }
    ...
    return (<AuthContext.Provider value={{ user, isAuthenticated: !!user, isLoading, isInitializing, login, signup, logout, updateGuestProfile, updateStaff }}>
            {children}
