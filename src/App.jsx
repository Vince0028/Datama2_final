...
const AppRoutes = () => {
    return (<Routes>
      ...
      <Route path="/guest/rooms" element={<GuestLayout>
          <GuestRooms />
        </GuestLayout>}/>
      <Route path="/guest/booking" element={<GuestLayout>
          <GuestBookings />
        </GuestLayout>}/>
      <Route path="/guest/profile" element={<GuestLayout>
          <GuestProfile />
        </GuestLayout>}/>
      ...
      <Route path="/staff/rooms" element={<StaffRoute>
          <Rooms />
        </StaffRoute>}/>
      <Route path="/staff/reservations" element={<StaffRoute>
          <Reservations />
        </StaffRoute>}/>
      <Route path="/staff/guests" element={<StaffRoute>
          <Guests />
        </StaffRoute>}/>
      <Route path="/staff/reports" element={<StaffRoute>
          <StaffReports />
        </StaffRoute>}/>
