...
export function RoomScheduleDialog({ roomId, roomName }) {
    ...
    return (<Dialog>
            ...
            <DialogContent className="w-auto p-0">
                ...
                <div className="p-4 flex flex-col items-center gap-4">
                    <Calendar mode="single" selected={date} onSelect={setDate} disabled={allDisabled} modifiers={{ booked: bookedDays, pending: pendingDays }} modifiersStyles={{
            booked: {
