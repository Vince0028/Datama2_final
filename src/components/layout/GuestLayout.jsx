...
import { Bed, Calendar, Home, LogIn, LogOut, User } from 'lucide-react';
...
export function GuestLayout({ children }) {
    ...
    return (<div className="min-h-screen bg-background flex flex-col">
            ...
            return (<Link key={item.name} to={item.href} className={cn("flex items-center gap-2 text-sm font-medium transition-colors hover:text-accent", isActive ? "text-accent" : "text-muted-foreground")}>
                        ...
                        <div className="flex items-center gap-2 ml-4">
                            {isAuthenticated && user?.User_Type === 'Guest' ? (<DropdownMenu>
