    ...
    return (<div className="min-h-screen bg-background flex flex-col">
            ...
            <section className="relative h-[85vh] flex items-center justify-center overflow-hidden">
                <div className="absolute inset-0 z-0">
                    <img src="https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80" alt="Hotel Lobby" className="w-full h-full object-cover brightness-[0.4]"/>
                </div>
            ...
            },
            {
                ...
                tag: ""
        ...
        ].map((room, i) => (<div key={i} className="group rounded-3xl overflow-hidden border bg-card shadow-sm hover:shadow-2xl transition-all duration-300 flex flex-col h-full">
                            <div className="h-72 overflow-hidden relative">
                                ...
                                {room.tag && (<div className="absolute top-4 left-4 bg-amber-500 text-black px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider shadow-md">
                                        {room.tag}
                                    </div>)}
                            </div>
                        ...
                        {[
            {
                ...
                icon: (<svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1"/></svg>),
            },
            {
                label: "Check-Out",
                time: "12:00",
                ...
                icon: (<svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"/></svg>),
            },
            {
                label: "Front Desk",
                time: "24/7",
        ...
        ].map((item, i) => (<div key={i} className="group bg-card p-10 rounded-2xl border border-border/60 text-center hover:shadow-xl hover:-translate-y-1 transition-all duration-500">
            ...
            { icon: Quote, title: "Concierge Service", desc: "Here for your every need." },
                        ...
                        <div className="relative order-1 lg:order-2 h-[500px] lg:h-[700px] rounded-[2rem] overflow-hidden shadow-2xl group">
                            <img src="https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80" alt="Amenities" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"/>
        ...
        ].map((t, i) => (<CarouselItem key={i} className="pl-4 md:basis-1/2 lg:basis-1/3">
                                <div className="p-1">
