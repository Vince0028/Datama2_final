...
export function setCachedToken(token) { _cachedToken = token; }
...
export async function rawQuery(table, options) {
    try {
...
export async function rawMutate(table, method, options = {}) {
    try {
        const token = options.token || _cachedToken || supabaseAnonKey;
